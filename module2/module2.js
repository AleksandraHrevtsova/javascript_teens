...
// //     // 12 = 12 + 4й аргумент (8) - 4я итерация
...
// // // // function expression
// // // // объявление/создание/инициализация функии
// // // const functionName = function(parametres) {
// // //   // instuctions
// // //   // instuctions
// // //   // instuctions
// // //   // instuctions
...
// // // // вызов функции - т.е. она начинает что-то делать,
// // // // а именно, то, что приписано внутри {} при объявлении
// // // functionName(arguments);

// // // // arguments = values of parametres

// // // // ARROW FUNCTION

// // // const arrowFunctionName = (
// // //   parametres // instuctions
// // // ) => arrowFunctionName(arguments);

// // // condition ? value(true) : value(false);
// const func = function(par = "true") {
//   console.log(par);
// };
